...
<head>
    ...
    <title>
        E-Del : Information Delivery Order 
    </title>
...
<body>
                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <p>Universitas Buana Perjuangan
                                    <br>Jalan Ronggo Waluyo Sirnabaya
                                    <br>Puseurjaya
                                    <br>Telukjambe
                                    <br>
                                    <strong>Karawang, 41361</strong>
                                </p>
                            </div>
                            <!-- /.col-sm-4 -->
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <ul>
                                    <li><strong><a href="mailto:">si20.nurhayadikastiawan@mhs.ubpkarawang.ac.id</a></strong>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.col-sm-4 -->
 ...
 <div id="copyright">
    <div class="container">
        <div class="col-md-6">
            <p class="pull-left">© Oma Cake 2022</p>
        </div>
        <div class="col-md-6">
...
<script>
    function initialize() {
        var mapOptions = {
            zoom: 15,
            center: new google.maps.LatLng(-6.32301,107.3014028,16.5),
        ...
        var myLatLng = new google.maps.LatLng(-6.32301,107.3014028,16.5);
