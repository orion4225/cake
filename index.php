...
<head>
    ...
    <title>
        Oma Cake : Information Delivery Order Tel-U
    </title>
    ...
    <link rel="shortcut icon" href="oma.png">
</head>
    ...
    <div class="container">
        <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    <img src="oma.png" class="hidden-xs">
                    <img src="oma.png" class="visible-xs"><span class="sr-only">Oma Cake - go to homepage</span>
                </a>
    ...
    <div id="content">
        ...
        <div class="container">
            <div class="col-md-12">
                <div id="main-slider">
                    <?php 
                    $q_slider=$conn->query("SELECT * FROM produk ORDER BY RAND() LIMIT 7");
        ...
        <div class="same-height-row">
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Special for UBP</h3>
                    <p>Aplikasi ini di khususkan untuk informasi delivery di kawasan karawang.</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <p>Aplikasi ini akan memberikan informasi lengkap mengenai menu kue di toko-toko area karawang</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
<div class="box text-center" data-animate="fadeInUp">
    <div class="container">
        <div class="col-md-12">
            <h3 class="text-uppercase"> Oma Cake bekerja sama dengan banyak toko. </h3>

            <p class="lead">Penasaran dengan toko-toko kami? <a href="toko.php">Check our Store!</a>
            </p>
        </div>
    </div>
</div>
...
<!-- /#content -->
 ...
 <div id="copyright">
    <div class="container">
        <div class="col-md-6">
            <a href="admin/index.php" style="color:white" target='_blank' >© Oma Cake 2022</a>
        </div>
        <div class="col-md-6">
            <p class="pull-right">Alright Reserved by me
            </p>
        </div>
    </div>
</div>
