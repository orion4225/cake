...
include 'protect.php';
$id_produk=$_GET['id'];
$query=$conn->query("SELECT * FROM produk JOIN toko ON produk.id_warung=toko.id_warung WHERE id_produk='$id_produk'");
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    ...
                    <img src="oma.png" class="visible-xs"><span class="sr-only">E-Del - go to homepage</span>
                </a>
            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="active"> <a href="toko.php">Patners</a>
                    </li>
                    ...
                    <!-- *** MENUS AND FILTERS ***
                     ...
                     <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Daftar Toko</h3>
                        </div>

                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                 <?php 
                                $query2=$conn->query("SELECT * FROM toko");

                                while ($data2=$query2->fetch_assoc()) {
                                    ?>
                                <li>
                                    <a href="toko.php?id=<?php echo $data2['id_warung']; ?>"><?php echo $data2['nama_warung']; ?></a>
                                </li>
                                    <?php
                                }
                                ?>
